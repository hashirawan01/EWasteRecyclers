...
public class userLoginAcctivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_login_acctivity);
        ...
        if (name != null) {
            Intent intent = new Intent(userLoginAcctivity.this, employePanelActivity.class);
        ...
        new_acc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(j);
                Toast.makeText(userLoginAcctivity.this, name, Toast.LENGTH_SHORT).show();
                String[] For_split_email = key_name.split("[@._]");
//                for (int n = 0; n <= For_split_email.length - 1; n++)
//                {
//                    Toast.makeText(getApplicationContext(),  For_split_email[n], Toast.LENGTH_SHORT).show();
//                }
            ...
            mauth.signInWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(userLoginAcctivity.this, "Login successfull", Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(userLoginAcctivity.this, "Error occured while login", Toast.LENGTH_SHORT).show();
                        progressDialog.dismiss();
                    }
                }
            });
